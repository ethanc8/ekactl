...
\begin{definition}[Positive definite]
  Let $A$ be a matrix. Then $A$ is positive definite iff any of the following equivalent statements are true
  \begin{itemize}
    \item All upper left determinants of $A$ are positive
    \item All eigenvalues of $A$ are positive
    \item All pivots of $A$ are positive
    \item For all $v \in \Real^n \setminus \{0\}$, $v^T A v > 0$
  \end{itemize}
\end{definition}

The definition of \textbf{negative definite} is the same except that the determinant/eigenvalue/pivot/$v^T A v$ must be negative, not positive.
