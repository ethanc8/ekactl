...
\begin{theorem}
  Let $f : X \in \Real^n \Rightarrow \Real$ whose $k$-th order and lower partials exist and are continuous on $X$. Then its $k$e-th order and lower partials may be evaluated in any order, i.e.
  \[
