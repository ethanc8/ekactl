...
\begin{theorem}[Properties of scalar multiplication]
  ...
  \begin{itemize}
    \item[(M1)] Associativity: $(\alpha\beta)v = \alpha(\beta v)$ 
    \item[(M2)] Distributivity over scalar addition: $(\alpha + \beta) v = \alpha v + \beta v$
    \item[(M3)] Distributivity over vector additon: $\alpha(v + w) = \alpha v + \alpha w$
    \item[(M4)] Multiplicative identity: $1v = v$
  \end{itemize}
\end{theorem}
