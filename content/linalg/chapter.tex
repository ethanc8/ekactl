...
\begin{definition}[$\mathcal{L}$]
  For any vector spaces $V$ and $W$, $\mathcal{L}(V,W)$ is the set of all linear maps from $V$ to $W$.
\end{definition}
...
\begin{definition}[Kernel]
  The kernel of a linear map $T : V \Rightarrow W$ is the set of vectors in $V$ which $T$ maps to the zero vector of $W$:
  \[
